...
def test_add_user_address_with_invalid_fields(global_config):
    ...
    # LOGGER.info("Endpoint: %s", global_config["Module4ApiEndpoint"])
    invalid_address = {"city": "Seattle", "stateProvince": "WA", "postal": "12345"}
    response = requests.post(
        global_config["Module4ApiEndpoint"] + '/address',
...
def test_update_user_address(global_config):
    ...
    response = requests.put(
        global_config["Module4ApiEndpoint"] + '/address/' + user1addresses['addresses'][0]['address_id'],
